    ...
    <div className="bg-slate-50 ">
      <section>
        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favourite memories with your own, <span className="font-semibold">one-of-one</span> phone ase.
          ...
          <div className="col-span-full lg:col-span-1 w-ful flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit ">
            <div className="relative md:nax-w-xl">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  <span className="p-0.5 bg-slate-800 text-white">The image is super clear</span>, on the case I had before the image started fading into-ish color after a couple weeks. Love it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img className='rounded-full h-12 object-cover' 
                src="/users/user-1.png"
                alt='user'
                />
